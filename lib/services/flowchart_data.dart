...
class FlowchartData {
    ...
    'check_motherboard': FlowchartStep(
      ...
      options: [
        FlowchartOption(
          ...
          subtitle: 'Voyant lumineux visible sur la carte mère et câbles 24+4/8 pins bien branchés',
          nextStepId: 'check_cmos',
        ),
        FlowchartOption(
          label: '✗ Pas de LED sur la carte mère',
          subtitle: 'Aucun voyant lumineux visible, même avec câbles bien connectés',
        ...
        FlowchartOption(
          ...
          subtitle: 'Câbles d\'alimentation desserrés ou mal insérés dans les connecteurs',
  ...
  static final List<FlowchartInfo> allFlowcharts = [
    ...
    FlowchartInfo(
      ...
      imagePath: 'assets/images/logigrammes/logigramme-depannage-hardware-p1-ne-sallume-pas.jpg',
    ),
    
    // HARDWARE - Pas d'affichage
    FlowchartInfo(
      id: 'hw_no_display',
      category: FlowchartCategory.hardware,
    ...
    // HARDWARE - S'éteint ou freeze
    FlowchartInfo(
      id: 'hw_shutdown_freeze',
      category: FlowchartCategory.hardware,
